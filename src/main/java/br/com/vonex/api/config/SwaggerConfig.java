package br.com.vonex.api.config;

import com.fasterxml.classmate.TypeResolver;

import br.com.vonex.api.controller.swagger.PageableSwagger;
...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.additionalModels(typeResolver.resolve(br.com.vonex.api.exception.handler.Problem.class))
